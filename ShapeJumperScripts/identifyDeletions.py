...
def makeDelEndsExactMatch(deletion, readNT, readSeq, refSeq):
    ...
    if shiftCounter > 10:
        print "Hey you had to shift "+str(shiftCounter)+" and still did not find exact match, skipping read "+readName
        badMatchCount += 1
        deletion = [-1,-1,-1, '']
    return deletion
...
def checkReadLen(seqCoords, readLength):
    ...
    if alignedLen > readLength + 10:
        print "HEY you\'re alignments are using more than the whole read at read "+readName
    ...
    if len(seqCoords) == 1:
        ...
        for i in range(len(seqCoords)-1):
            ...
            if inside(a1ReadStart,a1ReadStop,a2ReadStart,a2ReadStop):
                print "HEY WOAH YOU HAVE A PROBLEM, ALIGNMENTS ARE REUSING THE SAME NTS FROM THE READ"
            ...
            for a0 in seqCoords[:i+1]:
                ...
                if inside(a0SeqStart, a0SeqStop, a2SeqStart, a2SeqStop):
                    print "HEY WOAH YOU HAVE A PROBLEM, ALIGNMENTS ARE REUSING THE SAME NTS FROM THE SEQUENCE at: "
            ...
            if(a2ReadStart - a1ReadStop > overlap):
                ...
                if a2SeqStart - a1SeqStop < -10 and (a2SeqStop - a1SeqStart > 0) and checkReadLen(seqCoords, readLength):
                    print "Hey, You might have a merged read on your hands."
                    print readName
...
if __name__ == '__main__':
    ...
    for i in range(len(fastaLines)):
        ...
        if line[0] == '>':
            ...
            #becuase this is how the aligner parses out the gene name from a fasta file.
